...
class TestBinance(unittest.TestCase):
    ...
    def test_get_symbols_info_from_exchanges_with_binance_good_response(self):
        self.binance.get_json = MagicMock(return_value=binance_symbol_info_response)
        response = self.binance.get_symbols_info_from_exchange()
    ...
    def test_get_symbols_info_from_exchanges_with_binance_error(self):
        self.binance.get_json = MagicMock(side_effect=RestMessengerError("error"))
        response = self.binance.get_symbols_info_from_exchange()
